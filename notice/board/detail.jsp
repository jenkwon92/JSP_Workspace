...
<script>
/*
GET: Http 프로토콜에서 헤더 정보에 데이터를 실어 나른다. 아무래도 헤더이다보니 전송가능한 양이 미미하다
		현실비유) 편지봉투에 데이터 노출하여 보내는 꼴임
POST:  Http프로토콜에서 바디영역에 데이터를 실어 나른다. 몸체이다보니 전송략에 한계가 없다.
		현실비유) 편지지에 데이터를 숨겨보내는 꼴임
*/
$(function(){
